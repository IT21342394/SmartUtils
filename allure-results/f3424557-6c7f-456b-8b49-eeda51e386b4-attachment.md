...
- Name: BMI Calculator Tests >> 15. Should reset filters in history section
- Location: D:\4Y2S\SQA\SmartUtils\tests\BMI.spec.js:101:7
...
Call log:
  - waiting for getByTestId('min-age-filter')
    ...
    at D:\4Y2S\SQA\SmartUtils\tests\BMI.spec.js:103:46
```
