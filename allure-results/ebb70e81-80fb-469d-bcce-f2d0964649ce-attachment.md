...
- Name: BMI Calculator Tests >> 11. Should filter history by age range
- Location: D:\4Y2S\SQA\SmartUtils\tests\BMI.spec.js:77:7
...
Call log:
  - waiting for getByTestId('min-age-filter')

    at D:\4Y2S\SQA\SmartUtils\tests\BMI.spec.js:79:46
```
...
- main:
  ...
  - button "Hide History"
  - text: No history yet. Your BMI calculations will appear here.
